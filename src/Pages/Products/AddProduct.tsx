  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      const newProduct = {
        ...
        rating: 4,
        reviews: 0,
        image: formData.image ? URL.createObjectURL(formData.image) : new URL('../../assets/Images/scarmblar.svg', import.meta.url).href
      };

      addProduct(newProduct);
      
      alert(t('products.productAdded') || 'Product added successfully!');
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary-100 transition-colors">
                    ...
                    >
                      ...
                      <span>{t('products.uploadImage') || 'Upload Image'}</span>
                    </label>
                    <p className="text-sm text-gray-500 mt-2">
                      {formData.image ? formData.image.name : t('products.noImageSelected') || 'No image selected'}
                    </p>
                  </div>
                </div>
              </div>
